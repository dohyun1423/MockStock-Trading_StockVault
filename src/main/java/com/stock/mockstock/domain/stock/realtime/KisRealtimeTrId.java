// KIS 국내주식 정규장/시간외 실시간 WebSocket TR ID와 세션 매핑을 관리한다.
...
public final class KisRealtimeTrId {
    ...
    public static boolean isTradeTrId(String trId) {
        return REGULAR_TRADE.equals(trId) || AFTER_HOURS_TRADE.equals(trId);
    }

    // 전달받은 TR ID가 호가 실시간 데이터인지 확인한다.
    public static boolean isOrderbookTrId(String trId) {
        return REGULAR_ORDERBOOK.equals(trId) || AFTER_HOURS_ORDERBOOK.equals(trId);
    }
